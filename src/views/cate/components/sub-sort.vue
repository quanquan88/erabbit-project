<template>
  <div class='sub-sort'>
    ...
    <div class="check">
      <LCheckbox @change="changeCheck" v-model="sortParams.inventory">仅显示有货商品</LCheckbox>
      <LCheckbox @change="changeCheck" v-model="sortParams.onlyDiscount">仅显示特惠商品</LCheckbox>
    </div>
  </div>
</template>
<script>
